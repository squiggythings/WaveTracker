        ...
        public void Update()
        {
            ...
            foreach (WaveBankElement e in waveBankElements)
            {
                ...
                if (e.Clicked)
                {
                    ...
                    if (!Audio.ChannelManager.instance.channels[FrameEditor.currentColumn / 5].waveEnv.toPlay.isActive)
                        Audio.ChannelManager.instance.channels[FrameEditor.currentColumn / 5].SetWave(i);
                }
