...
namespace WaveTracker.UI {
    public class ConfigurationDialog : Dialog {
        ...
        public ConfigurationDialog() : base("Preferences...", 386, 300) {
            ...
            pages["General"].AddCheckbox("Use high resolution text (requires restart)", "Replaces the default stylized text with a more legible font");
        ...
        private void ReadSettings() {
            ...
            pages["General"]["Use high resolution text (requires restart)"].ValueBool = App.Settings.General.UseHighResolutionText;
        ...
        private void ApplySettings() {
            ...
            App.Settings.General.UseHighResolutionText = pages["General"]["Use high resolution text (requires restart)"].ValueBool;
