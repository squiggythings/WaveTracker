	...
	public class App : Game {
		...
		protected override void Initialize() {
			...
			MenuStrip.AddButton("Module", new Menu(new MenuItemBase[] {
				new MenuOption("Module Settings", PatternEditor.InsertNewFrame),
				null,
				new SubMenu("Cleanup", new MenuItemBase[] {
						new MenuOption("Remove unused instruments", PatternEditor.IncreaseNote),
						new MenuOption("Remove unused waves", PatternEditor.DecreaseNote),
				})
			}));
